...
<head>
    ...
    <script defer src="./pheptru.js">

    </script>
    <title>GAMEs: ĐỔ NƯỚC (POUR WATER)</title>
</head>
    ...
    <?php if ($da_hoan_thanh): ?>
        <div class="overlay">
            <div class="overlay-content">
                <h2>Đã hoàn thành</h2>
                <p>Bạn đã hoàn thành bài tập này, không được phép làm lại.</p>
            </div>
        </div>
    <?php endif; ?>
    <!-- begin phần thưởng -->
    ...
    <script>
        function checkAnswer1() {
            ...
            if (check) {
                ...
                alert("BẠN ĐÃ TRẢ LỜI SAI. HÃY THỬ LẠI NHÉ!!!ll");
                fetch('../../nhan_biet_gui_dl.php', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded',
